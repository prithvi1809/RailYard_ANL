...
from AugmentUtils.augments_rail import (
    ask4Area,
    filterNetwork,
    constructYardNetwork,
    generatePolygon, 
    generateBNetwork,
    generateANetwork, 
    autoDownloadNetwork,
...
if OPENAI_CONFIG['OPENAI_API_TYPE'] == 'azure':
    ...
    llm = ChatOpenAI(
        ...
        model_name='gpt-4',  # or any other model with 8k+ context
        max_tokens=1024,
        request_timeout=60
    )
...
toolModels = [
    ...
    constructYardNetwork(figfolder), 
    generatePolygon(),
    generateBNetwork(),
    generateANetwork(),
...
You can do following:[queryAreaRange,showOnMap, autoDownloadOpenStreetMapFile, simulateOnLibsignal, networkFilter, constructYardNetwork, generatePolygon, generateBNetwork, generateANetwork, gegenerateDemand, simulateOnDLSim, visualizeDemand, logAnalyzer, Multilanguage understanding and response, Introduce yourself, oneClickSUMOSimulation, ODMatrixTest, etc.] (return feedback, check again the tools you can do.)
[HOW ARE YOU]
...
5. [Description]: When you realize that existing tools are not solving the problem at hand, you need to end your actions and ask the human for more information as your final answer.
